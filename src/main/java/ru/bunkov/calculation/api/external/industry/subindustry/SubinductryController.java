package ru.bunkov.calculation.api.external.industry.subindustry;
...
import static ru.bunkov.calculation.api.external.industry.subindustry.mapper.SubIndustryMapper.SUB_INDUSTRY_MAPPER;
